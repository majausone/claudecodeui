...
import { FolderOpen, Folder, Plus, MessageSquare, Clock, ChevronDown, ChevronRight, Edit3, Check, X, Trash2, Settings, FolderPlus, RefreshCw, Sparkles, Edit2, Star, Search, AlertTriangle, Users } from 'lucide-react';
      ...
      <div className="md:p-2 md:border-t md:border-border flex-shrink-0">
        ...
        <div className="md:hidden p-4 pb-20 border-t border-border/50 space-y-2">
          ...
          >
            ...
            <span className="text-lg font-medium text-foreground">Teams</span>
          </button>
          <button
            className="w-full h-14 bg-muted/50 hover:bg-muted/70 rounded-2xl flex items-center justify-start gap-4 px-4 active:scale-[0.98] transition-all duration-150"
        ...
        <div className="hidden md:flex gap-1">
          ...
          <Button
            variant="ghost"
            className="justify-start gap-2 p-2 h-auto font-normal text-muted-foreground hover:text-foreground hover:bg-accent transition-colors duration-200"
            onClick={onShowTeams}
          >
